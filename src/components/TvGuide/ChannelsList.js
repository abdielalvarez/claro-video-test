  ...
  return (
    <div className="tv-guide-channel-list">
      ...
      <div className="channels-list__header date-container">
        <button data-testid="back-button" onClick={handleBack} className="tv-guide-channel-list__button">{'<'}</button>
        <div className="tv-guide-channel-list__date">{selectedDate.date}</div>
        <button data-testid="forward-button" onClick={handleForward} className="tv-guide-channel-list__button">{'>'}</button>
      </div>
